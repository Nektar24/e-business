...
== Description ==
**Quick WordPress Website Accessibility Remediation with All in One Accessibility plugin!**
...
**Note:** To start a 10 days free trial, subscription is required. You can cancel it anytime. Credit card will be charged after 10 days.
...
== Upgrade Notice ==
= 1.7 =
Version fully tested with WordPress 6.5.4

== Screenshot ==
1. Features of Pro Version
2. Supports 140 languages
3. Settings to manage widget Color, position
4. Once Plugin activate, accessibility icon will be display on the website
